...
// headerRow.createCell(2).setCellValue("Option A");
// headerRow.createCell(3).setCellValue("Option B");
// headerRow.createCell(4).setCellValue("Option C");
// headerRow.createCell(5).setCellValue("Option D");
// headerRow.createCell(6).setCellValue("Option E");
// headerRow.createCell(7).setCellValue("Option F");
// headerRow.createCell(8).setCellValue("Correct Answer");
